...
public class  PageContainer implements Serializable {
	...
	public Map<String,Object> createParameter(Map<String,Object> para){
		int page = (Integer) para.get("page");
		int total = (Integer) para.get("total");
	...
	public Map<String,Object> createParameter(Map<String,Object> para,int total){
		int page = (Integer)para.get("currentPage");
		return createParameter(para,page,total);
	}
	...
	public Map<String,Integer> createRedisParameter(int page,int total){
		...
		int begin = (Integer)para.get("begin");
		int count = (Integer)para.get("count");
